...
pub use domain::{
    AgentConversationMessage, AgentMessageRole, AgentPageContext, AgentPageKind, AgentSearchResult,
    AgentSearchResultKind, AiPreferences, AiProvider, BatchMountDisposition, BatchMountPlan,
    BatchMountPlanItem, BatchMountRequest, BundleUpdateAction, BundleUpdateBatchPlan,
    BundleUpdateBatchPlanItem, BundleUpdateBatchPlanItemDisposition, BundleUpdateBatchResult,
    BundleUpdateBatchResultItem, BundleUpdateBatchResultItemStatus, BundleUpdateBatchResultStatus,
    BundleUpdateImpact, BundleUpdateStatus, BundleUpdateSummary, EditableLocalRelinkMember,
    EditableLocalRelinkPlan, InstallCandidate, InstallInputKind, InstallMode, InstallPlan,
    InstallationChain, InstallationChainKind, InterfaceLanguage, InventoryItem,
    ...
    MountPlan, MountPlanPurpose, MountScope, MountSummary, PlatformInfo, ProjectSelection,
    ProjectSummary, RecoveryIssue, RemovalBundleSummary, RemovalKind, RemovalMemberSummary,
    RemovalPlan, RemovalPreservedSource, ScanIssue, ScanIssueCode, ScanRootKey, SkillAiExplanation,
    SkillCategory, SkillMetadataStatus, SkillsShSearchMember, SkillsShSearchSource,
