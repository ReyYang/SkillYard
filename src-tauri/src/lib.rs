...
pub use domain::{
    ...
    AgentSearchResultKind, AgentStreamEvent, AiPreferences, AiProvider, BatchMountDisposition,
    BatchMountPlan, BatchMountPlanItem, BatchMountRequest, BundleUpdateAction,
    ...
    BundleUpdateBatchResultStatus, BundleUpdateImpact, BundleUpdateStatus, BundleUpdateSummary,
    DiscoverLocalSkill, DiscoverWebResult, DiscoverWebResultKind, EditableLocalRelinkMember,
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::open_discover,
            commands::search_discover_web,
