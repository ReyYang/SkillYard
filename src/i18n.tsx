...
const EN_MESSAGES = {
  ...
  "项目": "Projects",
  "添加 Bundle": "Add Bundle",
  "筛选": "Filters",
  "筛选与排序": "Filter and sort",
  "全部 Bundle": "All Bundles",
  "清除筛选": "Clear filters",
  "更多": "More",
  "更多操作": "More actions",
  "打开": "Open",
  ...
  "更多 Bundle 操作": "More Bundle actions",
  "精选成员": "Featured members",
  "名称": "Name",
  "类型": "Type",
  "描述": "Description",
  "SKILL.md 描述": "SKILL.md description",
  "打开 Bundle": "Open Bundle",
  "查看 Skill": "View Skill",
  "查看 Bundle": "View Bundle",
  "查看分组": "View group",
  ...
  "还有 {count} 处 Mount": "{count} more Mounts",
  "状态提示": "Status notices",
  "设置": "Settings",
  "返回": "Back",
  "返回上一页": "Back",
  ...
  "保存 API Key 后可测试连接": "Save an API Key to test the connection",
  "同意向 Provider 发送测试请求后可测试连接":
    "Allow a test request to the Provider to test the connection",
  "连接尚未测试": "Connection not tested",
  ...
  "全部分类": "All categories",
  "排序": "Sort",
  "管理状态优先": "Management status first",
  "名称 A–Z": "Name A–Z",
  "适用场景": "Use cases",
  "使用说明": "Instructions",
  "开发与工程": "Development & Engineering",
  "系统与运维": "Systems & Operations",
  "效率与自动化": "Productivity & Automation",
  "数据与分析": "Data & Analytics",
  "产品与业务": "Product & Business",
  "研究与学习": "Research & Learning",
  "写作与沟通": "Writing & Communication",
  ...
  "已添加来源": "Added Sources",
  "已加载的 Source 中没有匹配成员": "No loaded Source members match",
  "输入关键词以筛选已保存的 Source 目录":
    "Type to filter saved Source catalogs",
  "已经安装": "Installed",
  "尚未安装": "Not installed",
  "查看 Source": "View Source",
  "目录尚未加载": "Catalog not loaded",
  "管理 {source}": "Manage {source}",
  ...
  "返回技能库并搜索 Bundle 或 Skill":
    "Return to the Skill Library and search Bundles or Skills",
  ...
  "补充来源": "Add Source",
  "批量挂载": "Batch Mount",
  "解除全部挂载：Bundle {bundle}": "Unmount all: Bundle {bundle}",
  "正在准备解除…：Bundle {bundle}": "Preparing unmount…: Bundle {bundle}",
  ...
  "未挂载": "Not mounted",
  "挂载异常 {count} 处": "{count} unhealthy mounts",
  "检查于 {time}": "Checked {time}",
  "查看 Skill {skill}": "View Skill {skill}",
  "查看详情": "View details",
  "来源未知": "Unknown Source",
  "Skill 详情": "Skill details",
  "SkillYard 助手": "SkillYard Assistant",
  "打开 SkillYard Assistant": "Open SkillYard Assistant",
  "关闭 SkillYard 助手": "Close SkillYard Assistant",
  "收起 SkillYard Assistant": "Collapse SkillYard Assistant",
  收起: "Collapse",
  ...
  "查看安装预览：{title}": "Preview installation: {title}",
  "正在准备…：{title}": "Preparing…: {title}",
  "无法打开这个外部链接，请稍后重试。":
    "Unable to open this external link. Please try again.",
  "无法准备这个来源的安装预览，请稍后重试。":
